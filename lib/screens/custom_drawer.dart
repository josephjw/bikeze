...
class _CustomDrawerState extends State<CustomDrawer> {
                    ...
                    itemBuilder: (BuildContext context, i) {
                      return InkWell(
                        ...
                        child: CustomListTile(
                            drawerItemList[i].image, drawerItemList[i].title,null,),
                      );
                    })),
            Spacer(),
      InkWell(
  ...
  void getData() {
    ...
    drawerItemList.add(
        new DrawerItemModel(title: 'PRIVACY POLICY', image: Icons.privacy_tip_outlined));
    drawerItemList.add(
        new DrawerItemModel(title: 'TERMS & CONDITION ', image: Icons.privacy_tip_outlined));
    // drawerItemList.add(
